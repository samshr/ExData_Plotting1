...
# Create Plot4 (Four different Plots in same window)
png("plot4.png", width=480, height=480) 
par(mfrow = c(2, 2))  
plot(cons$Date_Time, cons$Global_active_power, type="l", xlab="", ylab="Global Active Power", cex=0.2) 
plot(cons$Date_Time, cons$Voltage, type="l", xlab="datetime", ylab="Voltage") 
...
plot(cons$Date_Time, cons$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power") 
dev.off() 
